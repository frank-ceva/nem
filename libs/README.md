...
This directory contains code shared across multiple tools. It is **shared-agent-owned** — tool agents must not modify it directly. The integration agent reviews all changes but does not build code here.
